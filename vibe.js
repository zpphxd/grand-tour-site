...
(function initVibeSearch(global) {
  ...
  var TERMS = [
    ...
    ['mountain biking', 'activity', 'gravel'], ['bikepacking', 'activity', 'gravel'],
    ['gravel riding', 'activity', 'gravel'], ['gravel', 'activity', 'gravel'],
    ['via ferrata', 'activity', 'climbing'], ['rock climbing', 'activity', 'climbing'],
    ['climbing', 'activity', 'climbing'],
    ['wild swimming', 'activity', 'water'], ['sea kayaking', 'activity', 'water'],
    ['kayaking', 'activity', 'water'], ['paddling', 'activity', 'water'],
    ['trail running', 'activity', 'trail'], ['trail run', 'activity', 'trail'],
